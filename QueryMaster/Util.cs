...
namespace QueryMaster {
    internal static class Util {
        private static readonly Dictionary<string, short> _goldSourceGames = new Dictionary<string, short> {
                                                                                                               { "Counter-Strike", 10 },
        ...
        internal static short GetGameId(string name) {
            if (_goldSourceGames.ContainsKey(name))
                return _goldSourceGames[name];
            return 0;
        }
