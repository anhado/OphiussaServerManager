    ...
    public class SqlLite
    {
        ...
        private bool ColumnExists(string tableName, string columnName)
        {
            try
            {
                ...
                {
                    if (dr.GetString("name") == columnName) return true; 
                }
