...
public class OSMThemeContainer : ContainerControl {
...
public class OSMControlBox : Control {
    ...
    protected override void OnMouseClick(MouseEventArgs e) {
        base.OnMouseClick(e);
        if (i > 0 & i < 28) {
            if(_minimizeBox) this.FindForm().WindowState = FormWindowState.Minimized;
        }
        else if (i > 30 & i < 75) {
            this.FindForm().Close();
        }
...
public class OSMButton_1 : Control {
...
public class OSMButton_2 : Control {
...
public class OSMToggle : Control {
    ...
    protected override void OnPaint(PaintEventArgs e) {
        ...
        checked {
            ...
            G.SmoothingMode = SmoothingMode.AntiAlias;
            G.FillPath(Gradient, (GraphicsPath)this.Pill(0, (int)Math.Round(unchecked((double)this.Height / 2.0 - (double)this.cHandle.Height / 2.0)), this.Width - 1, this.cHandle.Height - 5, new OSMToggle.PillStyle {
                Left = true,
                Right = true
            }));
            G.DrawPath(new Pen(Color.FromArgb(177, 177, 176)), (GraphicsPath)this.Pill(0, (int)Math.Round(unchecked((double)this.Height / 2.0 - (double)this.cHandle.Height / 2.0)), this.Width - 1, this.cHandle.Height - 5, new OSMToggle.PillStyle {
                Left = true,
                Right = true
            }));
            Gradient.Dispose();
            switch (this.ToggleType) {
                case OSMToggle._Type.YesNo: {
...
public class OSMLinkLabel : LinkLabel {
...
public class OSMHeaderLabel : Label {

    public OSMHeaderLabel() {
...
public class OSMTextBox_Big : Control {
    #region Variables
...
[DefaultEvent("TextChanged")]
public class OSMTextBox_Small : Control {
    #region Variables
    ...
    protected override void OnEnter(System.EventArgs e) {
        base.OnEnter(e);
        iTalkTB.BackColor = Color.LightSkyBlue;
    }
...
[DefaultEvent("TextChanged")]
public class OSMRichTextBox : Control {
...
public class OSMNumericUpDown : Control {
...
public class OSMChatBubble_L : Control {
...
public class OSMChatBubble_R : Control {
...
public class OSMSeparator : Control {
...
public class OSMPanel : ContainerControl {
...
public class OSMGroupBox : ContainerControl {
...
public class OSMCheckBox : CheckBox {
    ...
    protected override void OnPaint(PaintEventArgs e) {
        ...
        // Draw the string
        _G.DrawString(Text, Font, new SolidBrush(SystemColors.ControlText), R1, new StringFormat { LineAlignment = StringAlignment.Center });
...
[DefaultEvent("CheckedChanged")]
public class OSMRadioButton : Control {
    ...
    private void InvalidateControls() {
        ...
        foreach (Control _Control in Parent.Controls) {
            if (!object.ReferenceEquals(_Control, this) && _Control is OSMRadioButton) {
                ((OSMRadioButton)_Control).Checked = false;
            }
        }
    }
...
public class OSMNotificationNumber : Control {
    #region Variables
...
public class OSMListview : ListView {
    ...
    protected override void OnHandleCreated(EventArgs e) {
        OSMListview.SetWindowTheme(this.Handle, "explorer", null);
        base.OnHandleCreated(e);
    }
}
...
public class OSMComboBox : ComboBox {
    ...
    protected override void OnDrawItem(DrawItemEventArgs e) {
        ...
        if (!(e.Index == -1)) {
            e.Graphics.DrawString(GetItemText(Items[e.Index]), e.Font,SystemBrushes.ControlText , e.Bounds);
        }
    }
    ...
    protected override void OnPaint(PaintEventArgs e) {
        ...
        //TODO:System.ArgumentException: 'O rectângulo '{X=0,Y=0,Width=0,Height=26}' não pode ter uma largura ou altura igual a 0.'
...
public class OSMProgressBar : Control {
...
public class OSMProgressIndicator : Control {
...
public class OSMTabControl : TabControl {
...
public class OSMTrackBar : Control {
...
public class OSMMenuStrip : MenuStrip {
...
public class OSMContextMenuStrip : ContextMenuStrip {

    public OSMContextMenuStrip() {
        this.Renderer = new ControlRenderer();
    }
...
public class OSMStatusStrip : StatusStrip {

    public OSMStatusStrip() {
        this.Renderer = new ControlRenderer();
        SizingGrip = false;
    }
...
public class OSMIcon_Info : Control {
    public OSMIcon_Info() {
        ForeColor      = SystemColors.ControlText;
...
public class OSMIcon_Tick : Control {
