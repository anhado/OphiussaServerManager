...
namespace OphiussaServerManagerV2
{
    public partial class MainForm : Form
    {
        ...
        {
            //if (txtPublicIP.PasswordChar == '*') txtPublicIP.PasswordChar = Convert.ToChar("");
            //else txtPublicIP.PasswordChar                                 = '*';
        }
        ...
        private void tabControl1_Click(object sender, EventArgs e)
        {
            if (tabControl1.TabCount == 1)
            {
                ...
                if (tabControl1.SelectedTab == NewTab)
                {
                    ...
                    {
                        PluginController nCtrl = Global.plugins[newServer.serversType.GameType].Clone(ServerUtils.InstallServerClick, ServerUtils.BackupServerClick, ServerUtils.StopServerClick, ServerUtils.StartServerClick);
